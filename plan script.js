...
document.getElementById('intro-1').innerHTML =  me.care_plan.workday.morning[1].dose_title.split(me.care_plan.workday.morning[1].product);
...
document.getElementById('intro-2').innerHTML =  me.care_plan.workday.afternoon[0].dose_title.split(me.care_plan.workday.afternoon[0].product);
...
document.getElementById('intro-4').innerHTML =  me.care_plan.workday.evening[0].dose_title.split(me.care_plan.workday.evening[0].product);
...
document.getElementById('intro-5').innerHTML =  me.care_plan.workday.evening[1].dose_title.split(me.care_plan.workday.evening[1].product);
...
document.getElementById('intro-6').innerHTML =  me.care_plan.workday.bedtime[0].dose_title.split(me.care_plan.workday.bedtime[0].product);
...
document.getElementById('intro-7').innerHTML =  me.care_plan.workday.bedtime[1].dose_title.split(me.care_plan.workday.bedtime[1].product);
...
document.getElementById('intro-8').innerHTML =  me.care_plan.non_workday.morning[0].dose_title.split(me.care_plan.non_workday.morning[0].product);
...
document.getElementById('prod-9').innerHTML = me.care_plan.non_workday.morning[1].product;
 document.getElementById('intro-9').innerHTML =  me.care_plan.non_workday.morning[1].dose_title.split(me.care_plan.non_workday.morning[1].product);
...
document.getElementById('prod-10').innerHTML = me.care_plan.non_workday.afternoon[0].product;
 document.getElementById('intro-10').innerHTML =  me.care_plan.non_workday.afternoon[0].dose_title.split(me.care_plan.non_workday.aftrenoon[0].product);
...
document.getElementById('prod-11').innerHTML = me.care_plan.non_workday.afternoon[1].product;
 document.getElementById('intro-11').innerHTML =  me.care_plan.non_workday.afternoon[1].dose_title.split(me.care_plan.non_workday.aftrenoon[1].product);
...
document.getElementById('intro-12').innerHTML =  me.care_plan.non_workday.evening[0].dose_title.split(me.care_plan.non_workday.evening[0].product);
...
document.getElementById('intro-13').innerHTML =  me.care_plan.non_workday.evening[1].dose_title.split(me.care_plan.non_workday.evening[1].product);
...
document.getElementById('intro-14').innerHTML =  me.care_plan.non_workday.bedtime[0].dose_title.split(me.care_plan.non_workday.bedtime[0].product);
...
document.getElementById('intro-15').innerHTML =  me.care_plan.non_workday.bedtime[1].dose_title.split(me.care_plan.non_workday.bedtime[1].product);
